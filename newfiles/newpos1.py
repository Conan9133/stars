...
dr21data=pd.read_csv("dr21Unew.csv")
...
dr21data['newy']=newy
dr21data['newz']=newz
exportcsv=dr21data.to_csv(r'/home/gnr/Downloads/SC/MYStIX_GAIA/new/final_dr21/newdata/dr21Unew1.csv',index=None,header=True)
