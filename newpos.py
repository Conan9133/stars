...
dr21data=pd.read_csv("dr21Fnew.csv")
...
exportcsv=dr21data.to_csv(r'/home/gnr/Downloads/SC/MYStIX_GAIA/new/final_dr21/newdata/dr21Fnew1.csv',index=None,header=True)
